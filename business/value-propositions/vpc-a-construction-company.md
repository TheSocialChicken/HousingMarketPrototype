...
The pain is not anecdotal. The research backing is quantified:
...
**Who:** Procurement managers, purchasing departments, project planners, and supplier relationship managers at mid-size construction companies (50–500 employees).

**Context:** Active project pipeline, multiple concurrent material procurement needs, working with a mix of preferred suppliers and spot purchases. Procurement is a core function but often under-resourced. Key knowledge often lives with one or two experienced buyers. Staff shortage is acute: 8 in 10 Dutch construction entrepreneurs report it; 20% cannot carry out all work due to lack of people.
...
|-----|------|------------|-------|
| Find and compare materials and suppliers for active projects | Functional | Critical | Daily activity; 11+ hrs/week spent here |
| Verify that suppliers hold current, correct certifications | Functional | Critical | Compliance and liability risk if missed; now compounded by CPR 2024 |
| Prepare supplier comparison reports for internal approval | Functional | High | Required before placing orders above a threshold |
| Manage and develop relationships with preferred suppliers | Functional | High | Trust and reliability matter as much as price |
| Reduce material and procurement cost without sacrificing quality | Functional | High | Materials = 40%+ of project cost; 0.5–1% profit eroded by poor procurement |
| Onboard new team members quickly | Functional | Medium | Turnover is common; knowledge transfer is slow and undocumented |
| Stay up to date with new suppliers and materials | Functional | Medium | New entrants with better specs or pricing go undiscovered |
| Avoid being blamed for project delays caused by wrong materials | Emotional | High | Reputational risk within the organisation |
| Appear informed and in control to project managers | Social | Medium | Credibility matters in cross-functional relationships |
...
|---|---|
| Spec to approved report in minutes | Automated matching + report generation |
| Fewer mistakes, lower variation costs | Specification-matched, ranked results with certification verification |
| Compliance confidence (Aanbestedingswet + CPR) | Certification checker integrated into every query |
| Institutional knowledge retained | Model trained on historical procurement data |
| Defensible decisions | Auto-generated audit-ready comparison report |
| Discover new suppliers | Enriched supplier database surfaces alternatives in fragmented market |
| AI improves over time | Scheduled retraining as new data accumulates |
| Data stays in-house | On-premise deployment; no API calls to external services |
...
|---|---|---|
| **Parspec** | AI for submittal/quoting for electrical/HVAC distributors; 50–80% faster submittal turnaround | Not a procurement decision engine; no local deployment; US and distributor focus |
| **Kojo** | Material cost control and inventory tracking for GCs; 3–5% cost reduction | Field materials focus, not specification-matching or compliance; no fine-tuning |
...
| Sales cycle | ★★★★☆ | 1–3 months; decision by procurement director or CFO |
...
A construction company is a good fit for a first pilot if they meet:
- [ ] Active project pipeline (not project-based / irregular)
- [ ] Minimum 2 years of procurement history in ERP or structured records (for fine-tuning)
- [ ] 2+ buyers in the procurement team (makes knowledge-sharing gain tangible)
- [ ] Recurring material procurement (not one-off custom builds only)
- [ ] Decision-maker accessible (procurement director, CFO, or operations director)
- [ ] IT environment open to on-premise deployment (server or private cloud)
