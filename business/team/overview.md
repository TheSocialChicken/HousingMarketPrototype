...
| Folder | Who |
|---|---|
| [core/christiaan-verhoef.md](core/christiaan-verhoef.md) | CEO / Product & Partnerships |
| [core/milan-jelisavic.md](core/milan-jelisavic.md) | CTO / AI Lead |
| [core/kirsten-coppoolse.md](core/kirsten-coppoolse.md) | COO / Operations |
| [core/nina-gluhovic.md](core/nina-gluhovic.md) | Domain Expert / Research |
| [advisors/gerard-tunteler.md](advisors/gerard-tunteler.md) | Head of Government Sales / Advisor |
| [advisors/dusko-stojanovic.md](advisors/dusko-stojanovic.md) | Züblin Insider / Domain Advisor |
| [cooperation.md](cooperation.md) | Pairings, decision rights, red flags, couple dynamics |
...
> Five people, two institutional anchors (Windesheim NL + Belgrade Serbia), and a direct line into every municipality in the Netherlands.

### Team Relationship Dynamics

Two of the five core team members are couples: Christiaan & Kirsten, and Milan & Nina. See the [cooperation guide](cooperation.md) for the direct treatment of how this is managed.

**Dusko Stojanovic** (Stuttgart) is an advisor — not a co-founder. Construction procurement practitioner at ZÜBLIN, introduced via Milan.
...
| Enterprise B2B sales (construction co.) | ⚠️ | | | | ⚠️ | ⚠️ Partial — construction sector sales via Windesheim network |
